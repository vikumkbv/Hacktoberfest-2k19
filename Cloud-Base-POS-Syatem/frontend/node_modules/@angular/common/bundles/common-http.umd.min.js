...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.ɵangular_packages_common_http_http_a=P,e.ɵangular_packages_common_http_http_b=R,e.ɵangular_packages_common_http_http_c=K,e.ɵangular_packages_common_http_http_d=z,e.ɵangular_packages_common_http_http_g=J,e.ɵangular_packages_common_http_http_h=B,e.ɵangular_packages_common_http_http_e=M,e.ɵangular_packages_common_http_http_f=F,e.HttpBackend=a,e.HttpHandler=s,e.HttpClient=x,e.HttpHeaders=h,e.HTTP_INTERCEPTORS=N,e.JsonpClientBackend=S,e.JsonpInterceptor=I,e.HttpClientJsonpModule=W,e.HttpClientModule=V,e.HttpClientXsrfModule=X,e.ɵHttpInterceptingHandler=D,e.HttpParams=m,e.HttpUrlEncodingCodec=f,e.HttpRequest=T,e.HttpErrorResponse=k,e.HttpHeaderResponse=j,e.HttpResponse=C,e.HttpResponseBase=E,e.HttpXhrBackend=U,e.XhrFactory=L,e.HttpXsrfTokenExtractor=q,Object.defineProperty(e,"__esModule",{value:!0})});